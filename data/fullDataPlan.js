const data = [
    ...
    },
    {
        ...
        desc: `<p>&emsp;This Government has launched the  Comprehensive School Infrastructure Development Scheme (CSIDS) during 2011-12 with an objective of providing basic infrastructure facilities like New Buildings, Kitchen sheds, Water supply, Toilets, etc., in the Panchayat Union Primary and Middle Schools in rural areas.  Repairs and renovation of the existing facilities will also be taken up wherever necessary.</p>
                ...
                <p>&emsp;Existing water supply system in the schools which are in damaged condition will be taken up for repairs.  Extension of pipeline will be provided wherever necessary.  New water supply connection from the Panchayat or a new bore well will also be provided wherever necessary.</p>
                <p>&emsp;Construction of new toilet shell be taken up based on the strength of students & number of possible staggered intervals of usage.  This Government shall ensure that all the Panchayat Union Schools have adequate toilet facilities for girl and boys.  Incinerators will be provided for the benefit of girl students in middle school.  This scheme is being implemented in the Panchayat Union schools located in Town Panchayats and Grade III Municipalities also.</p>
                <p>&emsp;As a measure to protect the school environment clean and to make the students safe, compound wall construction was also allowed from 2012-13 onwards.</p>
                <p>&emsp;Committees have been constituted at the district level to take up a detailed assessment of need based on THAI survey for ascertaining the infrastructural needs of the schools.</p>`,
    ...
    },
    {
        ...
        desc: `<p>&emsp;The MLACDS is fully funded by the State Government and each MLA identifies and proposes the works to be executed in his Constituency. The Scheme is implemented both in rural and urban areas. The main objective of the Scheme is to identify and implement the essential works to bridge the critical infrastructure gaps in the Assembly Constituencies. The allocation of funds under the Scheme had been increased from Rs.1.75 crore to Rs.2.00 crore per Constituency per annum from 2011-2012 onwards.</p>
               ...
               <p>&emsp;The MLAs identify the infrastructure gaps in their constituencies and propose the works to be executed under the MLACDS. The scheme is implemented both in Rural and Urban areas. The fund allocation under the scheme is Rs.2.00 crore per constituency per annum.</p>
    ...
    },
    {
        ...
        desc: `<p>&emsp;Provision of sanitary facilities for women was one of the priority areas of the Rural Development Department when this Government was in power in 2001.  The non availability of sanitary facilities impacts women and they suffer in silence.  Absence of sanitary facilities is primarily due to both poverty and cultural inhibitions, which had to be overcome.  Therefore, it was of paramount importance to ensure privacy and safety to women besides improving general hygiene and health to the rural people.</p>
               ...
               <p>&emsp;Rs.2.00 lakh each.  Between 2001 and 2004, all the Village Panchayats in the State were covered under the Scheme with the enhanced unit cost of Rs. 2.25 lakh.  However, most of the Integrated Sanitary Complexes for Women were rendered unusable since the previous Government did not give adequate attention for its maintenance.</p>
               <p>&emsp;As per the directions of the Hon’ble Chief Minister, 12,796 sanitary complexes which were in the state of disuse have been renovated at a cost of Rs.170 crore during 2011-12, thereby restoring the basic facilities of the rural women.</p>`,
